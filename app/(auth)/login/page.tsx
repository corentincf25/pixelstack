  ...
  return (
    <div className="space-y-6 rounded-xl border border-border bg-card p-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-muted-foreground">Pixelstack — miniatures YouTube</p>
      </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="space-y-6 rounded-xl border border-border bg-card p-6 text-center text-muted-foreground">Chargement…</div>}>
      <LoginForm />
    </Suspense>
  );
}
